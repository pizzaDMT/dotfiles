...
# Using slightly dimmed Catppuccin Frappe colors
$PEACH_LEAD = "$([char]27)[38;2;245;180;141m"    # Lighter Frappe Peach for lead character
            ...
            foreach ($drop in $drops) {
                ...
                for ($j = 0; $j -lt $totalLength; $j++) {
                    ...
                    if ($posY -ge 0 -and $posY -lt $height -and $posX -ge 0 -and $posX -lt $width) {
                        ...
                        if ($j -eq 0) { 
                            # Lead character is lighter peach
                            $color = $PEACH_LEAD 
                        }
